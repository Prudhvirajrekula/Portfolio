  ...
  <div className="mt-4 flex justify-between w-full">
    ...
    <p className="text-lg text-right">Jul 2019 – Apr 2023</p>
            ...
            <div className="mt-6 flex justify-center gap-6">
              {/* LinkedIn Icon */}
              <a href="https://www.linkedin.com/in/prudhvirajrekula/" target="_blank" rel="noreferrer noopener" className="hover:text-blue-600 transition">
                <FaLinkedin size={30} />
              </a>

              {/* GitHub Icon */}
              <a href="https://github.com/Prudhvirajrekula" target="_blank" rel="noreferrer noopener" className="hover:text-gray-900 transition">
                <FaGithub size={30} />
              </a>
