...
"Successfully managed a database of over 1000 flights and 2000 passenger records, ensuring seamless admin operations."
          ...
          {
            title: "PacketSniffer",
            link: "https://github.com/Prudhvirajrekula/PacketSniffer",
            points: [
              "Engineered a Python-based Packet Sniffer, monitoring and analyzing over 1,000 network packets per minute, improving anomaly detection by 35%.",

"Implemented filtering for TCP, UDP, and ICMP packets across IPv4 and IPv6, ensuring comprehensive network traffic analysis with 99% accuracy.",

"Executed real-time tracking and analysis of network traffic, reducing potential vulnerabilities by 40%."
            ]
          },
          {
            title: "HumanBodyDetection (OpenCV)",
            link: "https://github.com/Prudhvirajrekula/HumanBodyDetection-OpenCV",
            points: [
              "Developed a real-time human detection system using OpenCV, achieving 95% accuracy in pedestrian and full body detection.",

"Processed video streams at a rate of 30 frames per second, analyzing over 2000 frames for efficient detection and counting of humans.",

"Implemented HOG and SVM algorithms to enhance detection capabilities, successfully identifying and counting up to 50 individuals in crowded scenarios."
            ]
          },
          {
